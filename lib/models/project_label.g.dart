...
ProjectLabel _$ProjectLabelFromJson(Map<String, dynamic> json) => ProjectLabel(
      id: json['id'] as int?,
      ...
      isProjectLabel: json['is_project_label'] as bool?,
    );

Map<String, dynamic> _$ProjectLabelToJson(ProjectLabel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
